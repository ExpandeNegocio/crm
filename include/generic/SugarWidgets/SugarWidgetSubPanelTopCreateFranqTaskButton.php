...
class SugarWidgetSubPanelTopCreateFranqTaskButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
    function &_get_form($defines, $additionalFormFields = null)
    {
        ...
        $franquicia->retrieve($defines['focus']->franquicia);
        ...
        $form = 'formfranq' . $defines['child_module_name'];
        ...
        $additionalFormFields['task_type']='FRANOTRO';
        $additionalFormFields['description']='Tarea asociada a la central';
        $additionalFormFields['assigned_user_name'] =$franquicia->getUser()->name;
