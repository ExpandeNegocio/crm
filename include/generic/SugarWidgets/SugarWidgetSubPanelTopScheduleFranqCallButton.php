 ...
 * "Powered by SugarCRM".
 ********************************************************************************/
class SugarWidgetSubPanelTopScheduleFranqCallButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
  function &_get_form($defines, $additionalFormFields = null)
  {
    ...
    $defines['parent_bean_name'] = 'Expan_Franquicia';
    ...
    $additionalFormFields['description'] = 'Llamada a la central';
