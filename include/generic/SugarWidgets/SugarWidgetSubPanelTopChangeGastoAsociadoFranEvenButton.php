...
class SugarWidgetSubPanelTopChangeGastoAsociadoFranEvenButton extends SugarWidgetSubPanelTopButton
{
    private $formato = "";   

    //button_properties is a collection of properties associated with the widget_class definition. layoutmanager
    function SugarWidgetSubPanelTopChangeGastoAsociadoFranEvenButton($button_properties=array())
    {
    ...
    {
        return $GLOBALS['app_strings']['LBL_CHANGE_GASTOS_ASOCIADOS_BUTTON_LABEL'];
    }
    ...
    function display(&$widget_data)
    {
        ...
        $bot='<input type="button" name="' . $this->getWidgetId() . '" id="' . $this->getWidgetId() . '" class="button"' . "\n"
            ...
            . ' value="' . $this->value. "\"\n"
            . " onclick='cambiarGastosAsociadosFranquiciaEvento();' />\n";                        
