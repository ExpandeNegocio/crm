...
<select name="{$fields.task_type.name}" 
id="{$fields.task_type.name}" 
title=''      accesskey='7'   
>
{if isset($fields.task_type.value) && $fields.task_type.value != ''}
{html_options options=$fields.task_type.options selected=$fields.task_type.value}
{else}
{html_options options=$fields.task_type.options selected=$fields.task_type.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.task_type.options }
{capture name="field_val"}{$fields.task_type.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.task_type.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.task_type.name}" 
id="{$fields.task_type.name}" 
title=''          accesskey='7'  
>
{if isset($fields.task_type.value) && $fields.task_type.value != ''}
...
<input
id="{$fields.task_type.name}-input"
name="{$fields.task_type.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.task_type.name}-image"></button><button type="button"
id="btn-clear-{$fields.task_type.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.task_type.name}-input', '{$fields.task_type.name}');sync_{$fields.task_type.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.task_type.name}{literal}");
...
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.task_type.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.task_type.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.task_type.name}');
{literal}
...
//global variable 
sync_{/literal}{$fields.task_type.name}{literal} = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.task_type.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.task_type.name}{literal}", syncFromHiddenToWidget);
{/literal}
...
<input type="text" name="{$fields.expan_gestionsolicitudes_tasks_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.expan_gestionsolicitudes_tasks_1_name.name}" size="" value="{$fields.expan_gestionsolicitudes_tasks_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.expan_gestionsolicitudes_tasks_1_name.id_name}" 
id="{$fields.expan_gestionsolicitudes_tasks_1_name.id_name}" 
value="{$fields.expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.expan_gestionsolicitudes_tasks_1_name.name}" id="btn_{$fields.expan_gestionsolicitudes_tasks_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.expan_gestionsolicitudes_tasks_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida","name":"expan_gestionsolicitudes_tasks_1_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.expan_gestionsolicitudes_tasks_1_name.name}" id="btn_clr_{$fields.expan_gestionsolicitudes_tasks_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.expan_gestionsolicitudes_tasks_1_name.name}', '{$fields.expan_gestionsolicitudes_tasks_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.expan_gestionsolicitudes_tasks_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
...
<input type="text" name="{$fields.expan_franquicia_tasks_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.expan_franquicia_tasks_1_name.name}" size="" value="{$fields.expan_franquicia_tasks_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.expan_franquicia_tasks_1_name.id_name}" 
id="{$fields.expan_franquicia_tasks_1_name.id_name}" 
value="{$fields.expan_franquicia_tasks_1expan_franquicia_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.expan_franquicia_tasks_1_name.name}" id="btn_{$fields.expan_franquicia_tasks_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.expan_franquicia_tasks_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"expan_franquicia_tasks_1expan_franquicia_ida","name":"expan_franquicia_tasks_1_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.expan_franquicia_tasks_1_name.name}" id="btn_clr_{$fields.expan_franquicia_tasks_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.expan_franquicia_tasks_1_name.name}', '{$fields.expan_franquicia_tasks_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.expan_franquicia_tasks_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
addToValidate('EditView', 'prioridad', 'int', false,'{/literal}{sugar_translate label='LBL_PRIORIDAD' module='Tasks' for_js=true}{literal}' );
...
addToValidate('EditView', 'task_type', 'enum', true,'{/literal}{sugar_translate label='LBL_TASK_TYPE' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'oportunidad_inmediata', 'bool', false,'{/literal}{sugar_translate label='LBL_OPORTUNIDAD_INMEDIATA' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'expan_franquicia_tasks_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_EXPAN_FRANQUICIA_TASKS_1_FROM_EXPAN_FRANQUICIA_TITLE' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'expan_gestionsolicitudes_tasks_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_EXPAN_GESTIONSOLICITUDES_TASKS_1_FROM_EXPAN_GESTIONSOLICITUDES_TITLE' module='Tasks' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'modified_by_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='Tasks' for_js=true}{literal}', 'modified_user_id' );
addToValidateBinaryDependency('EditView', 'expan_franquicia_tasks_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_EXPAN_FRANQUICIA_TASKS_1_FROM_EXPAN_FRANQUICIA_TITLE' module='Tasks' for_js=true}{literal}', 'expan_franquicia_tasks_1expan_franquicia_ida' );
addToValidateBinaryDependency('EditView', 'expan_gestionsolicitudes_tasks_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_EXPAN_GESTIONSOLICITUDES_TASKS_1_FROM_EXPAN_GESTIONSOLICITUDES_TITLE' module='Tasks' for_js=true}{literal}', 'expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida' );
