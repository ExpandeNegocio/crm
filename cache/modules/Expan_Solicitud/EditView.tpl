...
<li class="selected"><a id="tab1" href="javascript:void(1)"><em>{sugar_translate label='LBL_EDITVIEW_PANEL4' module='Expan_Solicitud'}</em></a></li>
<li class="selected"><a id="tab2" href="javascript:void(2)"><em>{sugar_translate label='LBL_EDITVIEW_PANEL2' module='Expan_Solicitud'}</em></a></li>
<li class="selected"><a id="tab3" href="javascript:void(3)"><em>{sugar_translate label='LBL_EDITVIEW_PANEL1' module='Expan_Solicitud'}</em></a></li>
</ul>
...
{/if}  
<input type='text' name='{$fields.phone_mobile.name}' id='{$fields.phone_mobile.name}' size='30' maxlength='100' value='{$value}' title='' tabindex='0'	  class="phone"  onBlur="controlTelefono(this,'{$fields.id.value}')">
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
{/if}  
<input type='text' name='{$fields.localidad_apertura_1.name}' 
id='{$fields.localidad_apertura_1.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.localidad_apertura_2.name}' 
id='{$fields.localidad_apertura_2.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.localidad_apertura_3.name}' 
id='{$fields.localidad_apertura_3.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.franquicias_contactadas.name}' 
id='{$fields.franquicias_contactadas.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.otras_franquicias.name}' 
id='{$fields.otras_franquicias.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.dispone_local.name}" value="0"> 
<input type="checkbox" id="{$fields.dispone_local.name}" 
name="{$fields.dispone_local.name}" 
value="1" title='' tabindex="0" {$checked} >
...
{/if}  
<input type='text' name='{$fields.negocio_anterior_local.name}' 
id='{$fields.negocio_anterior_local.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.descripcion_local.name}' 
id='{$fields.descripcion_local.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
addToValidate('EditView', 'cuando_empezar', 'enum', false,'{/literal}{sugar_translate label='LBL_CUANDO_EMPEZAR' module='Expan_Solicitud' for_js=true}{literal}' );
...
addToValidate('EditView', 'dispone_local', 'bool', false,'{/literal}{sugar_translate label='LBL_DISPONE_LOCAL' module='Expan_Solicitud' for_js=true}{literal}' );
addToValidate('EditView', 'negocio_anterior_local', 'varchar', false,'{/literal}{sugar_translate label='LBL_NEGOCIO_ANTERIOR_LOCAL' module='Expan_Solicitud' for_js=true}{literal}' );
...
addToValidate('EditView', 'descripcion_local', 'varchar', false,'{/literal}{sugar_translate label='LBL_DESCRIPCION_LOCAL' module='Expan_Solicitud' for_js=true}{literal}' );
...
addToValidate('EditView', 'localidad_apertura_1', 'varchar', false,'{/literal}{sugar_translate label='LBL_LOCALIDAD_APERTURA_1' module='Expan_Solicitud' for_js=true}{literal}' );
addToValidate('EditView', 'localidad_apertura_2', 'varchar', false,'{/literal}{sugar_translate label='LBL_LOCALIDAD_APERTURA_2' module='Expan_Solicitud' for_js=true}{literal}' );
addToValidate('EditView', 'localidad_apertura_3', 'varchar', false,'{/literal}{sugar_translate label='LBL_LOCALIDAD_APERTURA_3' module='Expan_Solicitud' for_js=true}{literal}' );
