 ...
 $GLOBALS["dictionary"]["Meeting"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'enum',
      'len' => 100,
      'options' => 'tipo_reunion_list',
      'comment' => 'Tipo de la reunion',
      'required' => true,
      'importable' => 'required',
    ),
    'provincia' => 
    array (
      'name' => 'provincia',
      'vname' => 'LBL_PROVINCIA_TYPE',
      'type' => 'enum',
      'len' => 100,
      'options' => 'provincias_meeting_list',
      'comment' => 'Provincia',
      'required' => true,
      'importable' => 'required',
    ),
    ...
    'expan_gestionsolicitudes_meetings_1_name' => 
    array (
    ...
    'expan_gestionsolicitudes_meetings_1expan_gestionsolicitudes_ida' => 
    array (
