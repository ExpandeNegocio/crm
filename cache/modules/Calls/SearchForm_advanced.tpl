...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='franquicia_advanced'>{sugar_translate label='LBL_FRANQUICIA' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='franquicia_advanced' name='franquicia_advanced[]' options=$fields.franquicia_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.franquicia_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='call_type_advanced'>{sugar_translate label='LBL_CALL_TYPE' module='Calls'}</label>
		</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='call_type_advanced' name='call_type_advanced[]' options=$fields.call_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.call_type_advanced.value}
   	   	</td>
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='gestion_agrupada_advanced'>{sugar_translate label='LBL_GESTION_AGRUPADA' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.gestion_agrupada_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.gestion_agrupada_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.gestion_agrupada_advanced.name}" name="{$fields.gestion_agrupada_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='provincia_apertura_1_advanced'>{sugar_translate label='LBL_PROVINCIA_APERTURA_1' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='provincia_apertura_1_advanced' name='provincia_apertura_1_advanced[]' options=$fields.provincia_apertura_1_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.provincia_apertura_1_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='origen_advanced'>{sugar_translate label='LBL_ORIGEN' module='Calls'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='origen_advanced' name='origen_advanced[]' options=$fields.origen_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.origen_advanced.value}
   	   	</td>
	</tr>
<tr>
	<td colspan='20'>
