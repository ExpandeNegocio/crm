<?php /* Smarty version 2.6.11, created on 2017-01-13 17:11:16
         compiled from cache/modules/Calls/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Calls/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Calls/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Calls/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Calls/SearchForm_advanced.tpl', 45, false),array('function', 'html_options', 'cache/modules/Calls/SearchForm_advanced.tpl', 49, false),array('function', 'sugar_getimage', 'cache/modules/Calls/SearchForm_advanced.tpl', 212, false),array('modifier', 'default', 'cache/modules/Calls/SearchForm_advanced.tpl', 220, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='franquicia_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FRANQUICIA','module' => 'Calls'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'franquicia_advanced','name' => 'franquicia_advanced[]','options' => $this->_tpl_vars['fields']['franquicia_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['franquicia_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='call_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALL_TYPE','module' => 'Calls'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'call_type_advanced','name' => 'call_type_advanced[]','options' => $this->_tpl_vars['fields']['call_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['call_type_advanced']['value']), $this);?>
...
" value='<?php if (empty ( $_REQUEST['range_date_start_advanced'] ) && ! empty ( $_REQUEST['date_start_advanced'] )):  echo $_REQUEST['date_start_advanced'];  else:  echo $_REQUEST['range_date_start_advanced'];  endif; ?>' title=''   size="11" style="width:100px !important;">
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='gestion_agrupada_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_GESTION_AGRUPADA','module' => 'Calls'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['gestion_agrupada_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['gestion_agrupada_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['gestion_agrupada_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['gestion_agrupada_advanced']['name']; ?>
"   >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='provincia_apertura_1_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROVINCIA_APERTURA_1','module' => 'Calls'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='origen_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ORIGEN','module' => 'Calls'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'origen_advanced','name' => 'origen_advanced[]','options' => $this->_tpl_vars['fields']['origen_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['origen_advanced']['value']), $this);?>
