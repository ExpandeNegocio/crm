<?php /* Smarty version 2.6.11, created on 2017-01-12 17:38:13
         compiled from cache/modules/Expan_Solicitud/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Expan_Solicitud/EditView.tpl', 44, false),array('function', 'sugar_translate', 'cache/modules/Expan_Solicitud/EditView.tpl', 51, false),array('function', 'counter', 'cache/modules/Expan_Solicitud/EditView.tpl', 59, false),array('function', 'html_options', 'cache/modules/Expan_Solicitud/EditView.tpl', 72, false),array('function', 'sugar_getimagepath', 'cache/modules/Expan_Solicitud/EditView.tpl', 301, false),array('function', 'sugar_getimage', 'cache/modules/Expan_Solicitud/EditView.tpl', 488, false),array('function', 'sugar_getjspath', 'cache/modules/Expan_Solicitud/EditView.tpl', 1733, false),array('function', 'multienum_to_array', 'cache/modules/Expan_Solicitud/EditView.tpl', 1978, false),array('function', 'sugar_help', 'cache/modules/Expan_Solicitud/EditView.tpl', 3174, false),array('function', 'sugar_number_format', 'cache/modules/Expan_Solicitud/EditView.tpl', 6166, false),array('function', 'sugar_getscript', 'cache/modules/Expan_Solicitud/EditView.tpl', 6305, false),array('modifier', 'default', 'cache/modules/Expan_Solicitud/EditView.tpl', 58, false),array('modifier', 'strip_semicolon', 'cache/modules/Expan_Solicitud/EditView.tpl', 66, false),array('modifier', 'lookup', 'cache/modules/Expan_Solicitud/EditView.tpl', 298, false),array('modifier', 'count', 'cache/modules/Expan_Solicitud/EditView.tpl', 378, false),)), $this); ?>
...
<div class="action_buttons"><input type="submit" name="save" id="save" class="submit" onClick="this.form.return_action.value='DetailView'; this.form.action.value='Save';  return validarSubOrigen('EditView');" value="Guardar Validado"/> <?php if (! empty ( $_REQUEST['return_action'] ) && ( $_REQUEST['return_action'] == 'DetailView' && ! empty ( $_REQUEST['return_id'] ) )): ?><input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
...
<li class="selected"><a id="tab1" href="javascript:void(1)"><em><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL4','module' => 'Expan_Solicitud'), $this);?>
</em></a></li>
<li class="selected"><a id="tab2" href="javascript:void(2)"><em><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL2','module' => 'Expan_Solicitud'), $this);?>
</em></a></li>
<li class="selected"><a id="tab3" href="javascript:void(3)"><em><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL1','module' => 'Expan_Solicitud'), $this);?>
</em></a></li>
</ul>
...
' title='' tabindex='0'	  class="phone"  onBlur="controlTelefono(this,'<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
')">
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean(); ?>
<?php if ($this->_tpl_vars['fieldsUsed'] > 0): ?>
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['localidad_apertura_1']['name']; ?>
' 
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['localidad_apertura_2']['name']; ?>
' 
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['localidad_apertura_3']['name']; ?>
' 
...
' size='30' maxlength='100' value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='0'	  class="phone" >
<td valign="top" id='observaciones_contacto_sec_label' width='12.5%' scope="col">
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['cuando_empezar']['value'] ) && $this->_tpl_vars['fields']['cuando_empezar']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['cuando_empezar']['options'],'selected' => $this->_tpl_vars['fields']['cuando_empezar']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['cuando_empezar']['options'],'selected' => $this->_tpl_vars['fields']['cuando_empezar']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['cuando_empezar']['options']); ?>
<?php ob_start();  echo $this->_tpl_vars['fields']['cuando_empezar']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start();  echo $this->_tpl_vars['fields']['cuando_empezar']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['cuando_empezar']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['cuando_empezar']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['cuando_empezar']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['cuando_empezar']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['cuando_empezar']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['cuando_empezar']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['franquicias_contactadas']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['franquicias_contactadas']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['otras_franquicias']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['otras_franquicias']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['dispone_local']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['dispone_local']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['dispone_local']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
<td valign="top" id='negocio_anterior_local_label' width='12.5%' scope="col">
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['negocio_anterior_local']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['negocio_anterior_local']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['descripcion_local']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['descripcion_local']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
addToValidate(\'EditView\', \'cuando_empezar\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CUANDO_EMPEZAR','module' => 'Expan_Solicitud','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'dispone_local\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DISPONE_LOCAL','module' => 'Expan_Solicitud','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'negocio_anterior_local\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NEGOCIO_ANTERIOR_LOCAL','module' => 'Expan_Solicitud','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'descripcion_local\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPCION_LOCAL','module' => 'Expan_Solicitud','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'localidad_apertura_1\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LOCALIDAD_APERTURA_1','module' => 'Expan_Solicitud','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'localidad_apertura_2\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LOCALIDAD_APERTURA_2','module' => 'Expan_Solicitud','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'localidad_apertura_3\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LOCALIDAD_APERTURA_3','module' => 'Expan_Solicitud','for_js' => true), $this); echo '\' );
