<?php /* Smarty version 2.6.11, created on 2017-01-11 19:03:19
         compiled from cache/modules/Tasks/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Tasks/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Tasks/DetailView.tpl', 55, false),array('function', 'sugar_getimagepath', 'cache/modules/Tasks/DetailView.tpl', 58, false),array('function', 'sugar_translate', 'cache/modules/Tasks/DetailView.tpl', 61, false),array('function', 'sugar_ajax_url', 'cache/modules/Tasks/DetailView.tpl', 265, false),array('modifier', 'strip_semicolon', 'cache/modules/Tasks/DetailView.tpl', 75, false),array('modifier', 'escape', 'cache/modules/Tasks/DetailView.tpl', 238, false),array('modifier', 'url2html', 'cache/modules/Tasks/DetailView.tpl', 238, false),array('modifier', 'nl2br', 'cache/modules/Tasks/DetailView.tpl', 238, false),)), $this); ?>
...
" id="delete_button"><?php endif; ?> <div class="clear"></div></div>
</div>
</td>
...
<td width='%' scope="col">
<?php if (! $this->_tpl_vars['fields']['task_type']['hidden']): ?>
...
<?php if (is_string ( $this->_tpl_vars['fields']['task_type']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['task_type']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['task_type']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['task_type']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['task_type']['options'][$this->_tpl_vars['fields']['task_type']['value']]; ?>
...
<td width='%' scope="col">
<?php if (! $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['hidden']): ?>
...
<?php if (! empty ( $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Expan_GestionSolicitudes&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
</div>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='%' scope="col">
<?php if (! $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['hidden']): ?>
...
<?php if (! empty ( $this->_tpl_vars['fields']['expan_franquicia_tasks_1expan_franquicia_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Expan_Franquicia&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1expan_franquicia_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="expan_franquicia_tasks_1expan_franquicia_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1expan_franquicia_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['expan_franquicia_tasks_1expan_franquicia_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
</div>
</td>
</tr>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
