<?php /* Smarty version 2.6.11, created on 2017-01-12 17:40:39
         compiled from cache/modules/Expan_GestionSolicitudes/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 58, false),array('function', 'counter', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 64, false),array('function', 'sugar_translate', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 70, false),array('function', 'html_options', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 189, false),array('function', 'sugar_getimagepath', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 217, false),array('function', 'sugar_getimage', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 448, false),array('function', 'sugar_help', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 2782, false),array('function', 'sugar_getscript', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 5818, false),array('modifier', 'strip_semicolon', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 71, false),array('modifier', 'lookup', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 214, false),array('modifier', 'count', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 294, false),array('modifier', 'default', 'cache/modules/Expan_GestionSolicitudes/EditView.tpl', 459, false),)), $this); ?>
...
return validarEdicion();" value="Guardar"/> <?php if (! empty ( $_REQUEST['return_action'] ) && ( $_REQUEST['return_action'] == 'DetailView' && ! empty ( $_REQUEST['return_id'] ) )): ?><input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
...
&record=<?php echo $_REQUEST['return_id']; ?>
'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
" id="CANCEL_HEADER"> <?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="irsol" id="irsol" class onClick="irSolicitud('<?php echo $this->_tpl_vars['fields']['expan_solicitud_expan_gestionsolicitudes_1expan_solicitud_ida']['value']; ?>
');" value="Ir Solicitud"/><?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="save" id="save" class="submit" 
...
');" value="Reenviar C1.4"/><?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="save" id="save" class="submit" 
onClick="abrirHermanas('<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
');" value="Abrir Hermanas"/><?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="save" id="save" class="submit" 
onClick="window.open('index.php?module=Calls&action=EditView&expan_gestionsolicitudes_calls_1_name=<?php echo $this->_tpl_vars['fields']['name']['value']; ?>
...
<?php $this->assign('value', "01/12/2017"); ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'Información de local','module' => 'Expan_GestionSolicitudes'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'Fecha Información de local','module' => 'Expan_GestionSolicitudes'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
&record=<?php echo $_REQUEST['return_id']; ?>
'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
" id="CANCEL_FOOTER"> <?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="irsol" id="irsol" class onClick="irSolicitud('<?php echo $this->_tpl_vars['fields']['expan_solicitud_expan_gestionsolicitudes_1expan_solicitud_ida']['value']; ?>
');" value="Ir Solicitud"/><?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="save" id="save" class="submit" 
onClick="reenvioInfo('C1','<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
');" value="Reenviar C1"/><?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="save" id="save" class="submit" 
onClick="reenvioInfo('C2','<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
...
addToValidate(\'EditView\', \'chk_resolucion_dudas\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'Resolucion de dudas (Llaman ellos)','module' => 'Expan_GestionSolicitudes','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'chk_recepcio_cuestionario\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'Recepción del cuestionario','module' => 'Expan_GestionSolicitudes','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'chk_responde_C1\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'Responde a C1','module' => 'Expan_GestionSolicitudes','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'chk_visita_local\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'Visita al local','module' => 'Expan_GestionSolicitudes','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'cuando_empezar\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CUANDO_EMPEZAR','module' => 'Expan_GestionSolicitudes','for_js' => true), $this); echo '\' );
