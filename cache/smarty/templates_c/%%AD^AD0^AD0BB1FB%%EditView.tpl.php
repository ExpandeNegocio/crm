<?php /* Smarty version 2.6.11, created on 2017-01-11 18:40:26
         compiled from cache/modules/Tasks/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Tasks/EditView.tpl', 46, false),array('function', 'counter', 'cache/modules/Tasks/EditView.tpl', 52, false),array('function', 'sugar_getimagepath', 'cache/modules/Tasks/EditView.tpl', 55, false),array('function', 'sugar_translate', 'cache/modules/Tasks/EditView.tpl', 58, false),array('function', 'html_options', 'cache/modules/Tasks/EditView.tpl', 83, false),array('function', 'sugar_getimage', 'cache/modules/Tasks/EditView.tpl', 525, false),array('function', 'sugar_getjspath', 'cache/modules/Tasks/EditView.tpl', 553, false),array('function', 'sugar_getscript', 'cache/modules/Tasks/EditView.tpl', 1228, false),array('modifier', 'default', 'cache/modules/Tasks/EditView.tpl', 51, false),array('modifier', 'strip_semicolon', 'cache/modules/Tasks/EditView.tpl', 69, false),array('modifier', 'lookup', 'cache/modules/Tasks/EditView.tpl', 108, false),array('modifier', 'count', 'cache/modules/Tasks/EditView.tpl', 188, false),)), $this); ?>
...
"/><?php endif; ?> <?php if ($this->_tpl_vars['fields']['id']['value'] != ""): ?><input type="button" name="save" id="save" class="submit" 
onClick="abrirSolicitudGestionEdicion('<?php echo $this->_tpl_vars['fields']['parent_id']['value']; ?>
');" value="Editar Gestion/Solicitud"/><?php endif; ?> <?php if ($this->_tpl_vars['bean']->aclAccess('detail')):  if (! empty ( $this->_tpl_vars['fields']['id']['value'] ) && $this->_tpl_vars['isAuditEnabled']): ?><input id="btn_view_change_log" title="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='task_type_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TASK_TYPE','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
...
<select name="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
" 
title=''      accesskey='7'   
>
<?php if (isset ( $this->_tpl_vars['fields']['task_type']['value'] ) && $this->_tpl_vars['fields']['task_type']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['task_type']['options'],'selected' => $this->_tpl_vars['fields']['task_type']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['task_type']['options'],'selected' => $this->_tpl_vars['fields']['task_type']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['task_type']['options']); ?>
<?php ob_start();  echo $this->_tpl_vars['fields']['task_type']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start();  echo $this->_tpl_vars['fields']['task_type']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
" 
title=''          accesskey='7'  
...
id="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['task_type']['name'];  echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['task_type']['name']; ?>
');
<?php echo '
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['task_type']['name'];  echo ' = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['task_type']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['task_type']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_START_DATE','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DUE_DATE','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORITY','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='expan_gestionsolicitudes_tasks_1_name_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_EXPAN_GESTIONSOLICITUDES_TASKS_1_FROM_EXPAN_GESTIONSOLICITUDES_TITLE','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida","name":"expan_gestionsolicitudes_tasks_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['expan_gestionsolicitudes_tasks_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
<td valign="top" id='oportunidad_inmediata_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_OPORTUNIDAD_INMEDIATA','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='expan_franquicia_tasks_1_name_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_EXPAN_FRANQUICIA_TASKS_1_FROM_EXPAN_FRANQUICIA_TITLE','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1expan_franquicia_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"expan_franquicia_tasks_1expan_franquicia_ida","name":"expan_franquicia_tasks_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['expan_franquicia_tasks_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFICADO_POR','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Tasks'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php echo smarty_function_sugar_getscript(array('file' => "include/javascript/EditLlamadas.js"), $this);?>
...
addToValidate(\'EditView\', \'prioridad\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORIDAD','module' => 'Tasks','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'task_type\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TASK_TYPE','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'oportunidad_inmediata\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OPORTUNIDAD_INMEDIATA','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'expan_franquicia_tasks_1_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EXPAN_FRANQUICIA_TASKS_1_FROM_EXPAN_FRANQUICIA_TITLE','module' => 'Tasks','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'expan_gestionsolicitudes_tasks_1_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EXPAN_GESTIONSOLICITUDES_TASKS_1_FROM_EXPAN_GESTIONSOLICITUDES_TITLE','module' => 'Tasks','for_js' => true), $this); echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'modified_by_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Tasks','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Tasks','for_js' => true), $this); echo '\', \'modified_user_id\' );
addToValidateBinaryDependency(\'EditView\', \'expan_franquicia_tasks_1_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Tasks','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_EXPAN_FRANQUICIA_TASKS_1_FROM_EXPAN_FRANQUICIA_TITLE','module' => 'Tasks','for_js' => true), $this); echo '\', \'expan_franquicia_tasks_1expan_franquicia_ida\' );
addToValidateBinaryDependency(\'EditView\', \'expan_gestionsolicitudes_tasks_1_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Tasks','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_EXPAN_GESTIONSOLICITUDES_TASKS_1_FROM_EXPAN_GESTIONSOLICITUDES_TITLE','module' => 'Tasks','for_js' => true), $this); echo '\', \'expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_parent_name\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'EditView_expan_gestionsolicitudes_tasks_1_name\']={"form":"EditView","method":"query","modules":["Expan_GestionSolicitudes"],"group":"or","field_list":["name","id"],"populate_list":["expan_gestionsolicitudes_tasks_1_name","expan_gestionsolicitudes_tasks_1expan_gestionsolicitudes_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'EditView_expan_franquicia_tasks_1_name\']={"form":"EditView","method":"query","modules":["Expan_Franquicia"],"group":"or","field_list":["name","id"],"populate_list":["expan_franquicia_tasks_1_name","expan_franquicia_tasks_1expan_franquicia_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'EditView_modified_by_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name","modified_user_id"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>
