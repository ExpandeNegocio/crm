<?php /* Smarty version 2.6.11, created on 2017-01-08 12:21:08
         compiled from include/DetailView/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'include/DetailView/DetailView.tpl', 47, false),array('function', 'sugar_evalcolumn', 'include/DetailView/DetailView.tpl', 187, false),array('function', 'sugar_field', 'include/DetailView/DetailView.tpl', 192, false),array('modifier', 'upper', 'include/DetailView/DetailView.tpl', 50, false),array('modifier', 'count', 'include/DetailView/DetailView.tpl', 139, false),)), $this); ?>
{*
/*********************************************************************************
...
'<?php endif; ?> <?php if (isset ( $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type'] ) && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type'] == 'phone'): ?>class="phone"<?php endif; ?>>
				<div style="width: 100%; min-height: 10px;" ondblclick="EDV.show_edit('<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
','<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type']; ?>
')" class="div_value" id="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
_detailblock" target_id="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
">
...
" class="sugar_field"><?php echo smarty_function_sugar_evalcolumn(array('var' => $this->_tpl_vars['colData']['field'],'colData' => $this->_tpl_vars['colData']), $this);?>
				...
				<?php if (! $this->_tpl_vars['colData']['field']['disable_edit']): ?> 																										<?php if ($this->_tpl_vars['module'] == 'Accounts' || $this->_tpl_vars['module'] == 'Contacts'): ?>
				<?php if (! empty ( $this->_tpl_vars['colData']['field']['name'] )): ?>
					{if !isset($fields.<?php echo $this->_tpl_vars['colData']['field']['name']; ?>
.acl) || (isset($fields.<?php echo $this->_tpl_vars['colData']['field']['name']; ?>
.acl) && $fields.<?php echo $this->_tpl_vars['colData']['field']['name']; ?>
.acl > 1) }
				<?php endif; ?>
				
				<div class='edit_block' style="display: none;" id='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
_editblock'>
						<?php if (( $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['required'] && ! isset ( $this->_tpl_vars['colData']['field']['displayParams']['required'] ) ) || ( isset ( $this->_tpl_vars['colData']['field']['displayParams']['required'] ) && $this->_tpl_vars['colData']['field']['displayParams']['required'] && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['required'] !== false )): ?>
							<input type='hidden' id='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
...
_required' value=''>
						...
						<?php if ($this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']] && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type'] == 'relate'): ?>
							<input type='hidden' id='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
_module' value='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['module']; ?>
'>
							<input type='hidden' id='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
_id_name' value='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['id_name']; ?>
'>
						<?php endif; ?>					
						
						<?php if ($this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']] && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name'] == 'email1'): ?>
							<input type='text' id='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
' value=''>	
						<?php elseif ($this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']] && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name'] == 'duration_hours'): ?>
							{literal}<script type="text/javascript">function isValidDuration() { form = document.getElementById('DetailView'); if ( form.duration_hours.value + form.duration_minutes.value <= 0 ) { alert('{/literal}{$MOD.NOTICE_DURATION_TIME}{literal}'); return false; } return true; }</script>{/literal}<input id="duration_hours" name="duration_hours" tabindex="1" size="2" maxlength="2" type="text" value="{$fields.duration_hours.value}" > <select name='duration_minutes' id='duration_minutes'><option value='0' {if $fields.duration_minutes.value  == 0} selected {/if}>00</option><option value='15' {if $fields.duration_minutes.value  == 15} selected {/if}>15</option><option value='30' {if $fields.duration_minutes.value  == 30} selected {/if}>30</option><option value='45' {if $fields.duration_minutes.value  == 45} selected {/if}>45</option></select> &nbsp;<span class="dateFormat">{$MOD.LBL_HOURS_MINUTES}</span>
						<?php elseif ($this->_tpl_vars['module'] == 'Calls' && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']] && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name'] == 'direction'): ?>
							<?php echo smarty_function_sugar_field(array('parentFieldArray' => 'fields','tabindex' => $this->_tpl_vars['colData']['field']['tabindex'],'vardef' => $this->_tpl_vars['fields']['direction'],'displayType' => 'EditView','displayParams' => $this->_tpl_vars['colData']['direction']['displayParams'],'formName' => $this->_tpl_vars['form_name']), $this);?>
&nbsp;
							<?php echo smarty_function_sugar_field(array('parentFieldArray' => 'fields','tabindex' => $this->_tpl_vars['colData']['field']['tabindex'],'vardef' => $this->_tpl_vars['fields']['status'],'displayType' => 'EditView','displayParams' => $this->_tpl_vars['colData']['status']['displayParams'],'formName' => $this->_tpl_vars['form_name']), $this);?>
&nbsp;
						<?php elseif ($this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']] && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['type'] == 'fullname'): ?>
							<input type='text' id='first_name' value='{$fields.first_name.value}' size=10>
							<input type='text' id='last_name' value='{$fields.last_name.value}' size=10>
							<button type='button' id='<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name']; ?>
'>{$APP.LBL_EDV_SAVE}</button>													
						<?php elseif ($this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']] && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name'] != 'date_entered' && $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]['name'] != 'date_modified'): ?>
							{counter name="panelFieldCount"}
