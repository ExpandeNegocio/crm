              ...
              array(
                'buttons' =>
                  array(
                    ...
                    5 =>
                      array(
                        'customCode' => '{if $fields.id.value!=""}<BR> <BR>' . $createButtonsHelper->createCxButton("C0.1") . '{/if}',
                      ),
                    6 =>
                      array(
                        'customCode' => '{if $fields.id.value!=""}<T>' . $createButtonsHelper->createCxButton("C1") . '{/if}',
                      ),
                    7 =>
                      array(
                  ...
                  array(
                    0 =>
                      array(
                        ...
                        'label' => 'LBL_ENTREVISTA_PREVIA_CANCELADA',
                      ),
                    1 =>
                      array(
