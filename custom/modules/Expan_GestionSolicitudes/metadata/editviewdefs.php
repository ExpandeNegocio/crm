...
$canc1=utilidades::canSend($focus->id,"c1");
$canc2=utilidades::canSend($focus->id,"c2");
$canc3=utilidades::canSend($focus->id,"c3");
$canc4=utilidades::canSend($focus->id,"c4");

//$canc11=utilidades::canSend($focus->id,"c11");
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          3 => 
          array (
            'customCode' => '{if $fields.id.value!=""} <input type="button" style="color:#0000FF;" name="irfran" id="irfran" class="" 
                    onClick="irFranquicia(\'{$fields.franquicia.value}\');" value="Ir Franquicia">{/if}',
          ),  
          
          4 => 
          array (
            'customCode' => '{if $fields.id.value!=""} <input type="button" style="color:#FF0000;" name="irsol" id="irsol" class="" 
          ...
          5 => 
          array (
            'customCode' => '{if $fields.id.value!=""} <BR><BR><input type="button" '.$canc1.' name="reenInfo1" id="reenInfo1" class="" 
          ...
          6 => 
          array (
            'customCode' => '{if $fields.id.value!=""} <input type="button" '.$canc2.' name="reenInfo2" id="reenInfo2" class="" 
        			title="Reenvio información Adicional (C2) (Plan financiero)"
        			onClick="reenvioInfoEdicion(\'C2\',\'{$fields.id.value}\');" value="Reenviar C2">{/if}',
          ),
          7 => 
          array (
            'customCode' => '{if $fields.id.value!=""} <input type="button" '.$canc3.' name="reenInfo3" id="reenInfo3" class="" 
        			title="Reenvio borrador precontrato (C3)"
        			onClick="reenvioInfoEdicion(\'C3\',\'{$fields.id.value}\');" value="Reenviar C3">{/if}',
          ),
          8 => 
          array (
            'customCode' => '{if $fields.id.value!=""} <input type="button" '.$canc4.' name="reenInfo4" id="reenInfo4" class="" 
        			title="Reenvio borrador contrato (C4)"
        			onClick="reenvioInfoEdicion(\'C4\',\'{$fields.id.value}\');" value="Reenviar C4">{/if}',
          ),
          9 => 
          array (
            'customCode' => '{if $fields.id.value!=""} <input type="button" '.$canc11.' name="reenInfo11" id="reenInfo11" class="" 
