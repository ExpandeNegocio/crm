...
$GLOBALS['log'] -> info('[ExpandeNegocio][EditViewdefs]Usuario-'.$current_user->id);

if  ($current_user->id=='875daf39-76a9-4eb7-2fbc-53c7fa8dec18' || 
    $current_user->id=='71f40543-2702-4095-9d30-536f529bd8b6' ||
    $current_user->id=='1'){
        
    $GLOBALS['log'] -> info('[ExpandeNegocio][EditViewdefs]Entra en administracion');    
   ...
   $GLOBALS['log'] -> info('[ExpandeNegocio][EditViewdefs]NO Entra en administracion');    
