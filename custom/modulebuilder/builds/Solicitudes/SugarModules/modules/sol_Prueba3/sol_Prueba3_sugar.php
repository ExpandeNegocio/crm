 ...
 * PLACE ANY CUSTOMIZATIONS IN sol_Prueba3
 */

require_once('include/SugarObjects/templates/person/Person.php');

class sol_Prueba3_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'sol_Prueba3';
	var $object_name = 'sol_Prueba3';
	var $table_name = 'sol_prueba3';
