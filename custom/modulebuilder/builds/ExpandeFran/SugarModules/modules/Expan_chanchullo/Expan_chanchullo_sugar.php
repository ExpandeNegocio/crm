 ...
 * PLACE ANY CUSTOMIZATIONS IN Expan_chanchullo
 */

require_once('include/SugarObjects/templates/company/Company.php');

class Expan_chanchullo_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'Expan_chanchullo';
	var $object_name = 'Expan_chanchullo';
	var $table_name = 'expan_chanchullo';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function Expan_chanchullo_sugar(){	
		parent::Company();
	}
