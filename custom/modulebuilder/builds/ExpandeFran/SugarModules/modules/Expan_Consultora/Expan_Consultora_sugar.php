 ...
 * PLACE ANY CUSTOMIZATIONS IN Expan_Consultora
 */

require_once('include/SugarObjects/templates/company/Company.php');

class Expan_Consultora_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'Expan_Consultora';
	var $object_name = 'Expan_Consultora';
	var $table_name = 'expan_consultora';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function Expan_Consultora_sugar(){	
		parent::Company();
	}
