<?php
    ...
    //Actualizamos las prioridadesde las gestiones         
    ...
    $query=$query."  on g.id=c.parent_id AND g.id=' ";
    ...
    $query=$query."  inner join expan_gestionsolicitudes g ";
    $query=$query."  on g.id=t.parent_id AND g.id=' ";
    ...
    $query=$query."  inner join expan_gestionsolicitudes g ";
    $query=$query."  on g.id=m.parent_id AND g.id=' ";
