...
class Expan_SolicitudDashlet extends DashletGeneric { 
    function Expan_SolicitudDashlet($id, $def = null) {
		global $current_user, $app_strings;
		require('modules/Expan_Solicitud/metadata/dashletviewdefs.php');
